...
import { deletarCadastroMotorista } from '../../methods/delete'
...
export default function DeleteModal({ open, setOpen, motorista }) {
  const handleClose = () => setOpen(false)

  const deletarMotorista = async () => {
    const response = await deletarCadastroMotorista(motorista.id)
    handleClose()
